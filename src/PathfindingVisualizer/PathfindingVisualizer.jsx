              ...
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" onClick={() => this.visualizeDijkstra()} href="#">Dijkstra's Algorithm</a></li>
                    <li><a className="dropdown-item" onClick={() => this.visualizeDijkstra()} href="#">Breadth First Search</a></li>
                    <li><a className="dropdown-item" onClick={() => this.visualizeDijkstra()} href="#">Depth First Search</a></li>
